  ...
  return (
    ...
    mx-auto'>
      ...
      <div className='md:w-[67%] lg:w-[40%] lg:ml-20 w-full'>
        <form>
          <input
          type="text" placeholder='Full name' id='fullname' value={fullname} onChange={onChange} className='w-full text-xl rounded-sm mb-5 transition ease-in-out'/>
          <input
          ...
          <button className='mt-5 bg-blue-600 hover:bg-blue-700 transition rounded-sm text-white text-center w-full p-2 font-semibold'>SIGN UP</button>
